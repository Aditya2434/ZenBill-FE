...
const Signup = ({ setView }) => {
  ...
  return (
    <div className="min-h-screen w-full flex bg-white font-sans">
      ...
      {/* ─── LEFT PANEL (Form) ─── */}
      <div className="flex-1 flex flex-col justify-center relative px-6 py-12 sm:px-12 lg:px-20 xl:px-32 overflow-y-auto">
        
        {/* Subtle ambient light */}
        <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] rounded-full bg-indigo-50 blur-[120px] pointer-events-none" />

        <div className="w-full max-w-[440px] mx-auto relative z-10 animate-fade-in-up">
          ...
          <p className="text-slate-500 text-sm font-medium mb-8">
            Start automating your invoices and managing your clients in minutes.
          </p>
          ...
          >
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all text-slate-900 placeholder:text-slate-400 font-medium hover:border-slate-300"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-bold text-slate-700 mb-1.5">State Code</label>
                <input
                  type="text"
                  value={code}
            ...
            <div className="relative group pt-2">
              <button
                ...
                className={`w-full flex items-center justify-center gap-2 rounded-xl px-4 py-4 text-sm font-bold text-white transition-all duration-200 ${
                  isValid && !isLoading
              ...
              {!isValid && missingFields.length > 0 && (
                <div className="pointer-events-none absolute -top-10 left-1/2 -translate-x-1/2 whitespace-nowrap rounded-lg bg-slate-900 text-white text-xs font-medium px-3 py-1.5 opacity-0 group-hover:opacity-100 transition-opacity shadow-xl z-20">
                  Missing: {missingFields.join(", ")}
                  <div className="absolute left-1/2 -bottom-1 -translate-x-1/2 w-2 h-2 rotate-45 bg-slate-900" />
                </div>
              )}
            </div>
          </form>
